<?php
$interestAreas = \App\Models\ContactInterestArea::getInterestAreas(true);
$geographicAreas = \App\Models\ContactGeographicArea::getGeographicAreas(true);
$populations = \App\Models\ContactPopulationServed::getPopulationServed(true);
?>
<script>
...
<div class="floating-btn text-center">
    <button type="submit" name="save" id="id_save_btn2" class="btn btn-accent" style="width:200px;">Submit</button>
</div>
