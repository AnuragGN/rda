...
@section ('content')
    ...
    <div class="accordion" id="id-accordion-successor">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-btn-bar text-center">
                            <div id="id-next-btn" class="col-12 form-footer">
                                <p class="action"><a href="/donor/contribution" class="btn btn-hga-md btn-wide btn-theme">SAVE & NEXT</a></p>
        ...
        <div class="container custom-form">
            {{-- Collapsible three --}}
            <p class="accordion-title">
                <a href="javascript:void(0)" class="accordion-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    <span id="arrow-right-three" class="arrow-right"></span>
                    <span id="arrow-down-three" class="arrow-down hide"></span>
                    Establish a Permanent Endowment
                    <span class="ft-normal">&nbsp;(Lasting Legacy Account - minimum $25,000)</span>
                </a>
            </p>

            <div id="collapseThree" class="collapse mt-3" aria-labelledby="headingThree" data-parent="#id-accordion-successor">

                <div class="form-group row">
                    <label for="id-giving" class="col-md-2 col-form-label text-right">Name of Endowment</label>
                    <div class="col-md-4 pl-0">
                        <input id="id-giving" name="giving" type="text" class="form-control" placeholder=""
                               required="">
                    </div>
    ...
    <div class="container text-right" style="margin-top: 6rem; margin-bottom: -3rem; z-index: 99999; position: relative;">
        <div class="row">
            <div class="col-12 col-form-label">
                <a href="/donor/successor" style="margin-left: 1rem">Main</a>
                <a href="/donor/successor-h-radio" style="margin-left: 1rem">Radio</a>
                <a href="/donor/successor-select" style="margin-left: 1rem">Select</a>
            </div>
        </div>
    </div>
