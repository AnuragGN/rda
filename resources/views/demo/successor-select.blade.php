...
@section ('content')
    ...
    <div class="container">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <select class="form-control" id="id-select-successor">
                    <option value="">Select successor type</option>
                    <option value="option-a">Individuals / Charitable Organizations</option>
                    <option value="option-b">Establish a Permanent Endowment</option>
                </select>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-btn-bar text-left">
                                <div id="id-next-btn" class="col-12 form-footer">
                                    <p class="action"><a href="/donor/contribution" class="btn btn-hga-sm btn-theme">Save</a></p>
                                </div>
                            </div>
