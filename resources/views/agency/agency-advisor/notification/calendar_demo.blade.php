...
$calendarEvents = [
    [
        ...
        'end' => '2024-05-16T10:00:00',
        'description' => 'Test description for Project Kickoff',
        'location' => 'Conference Room A',
        'timezone' => 'Asia/Kolkata',
        'meetLink' => 'https://googlemeet.com12345',
    ...
    [
        ...
        'description' => 'Test description for Weekly Standup',
        'location' => 'Virtual Meeting',
        'timezone' => 'America/Los_Angeles',
        'meetLink' => 'https://googlemeet.com1234',
        'attendees' => [['email' => 'alice@example.com'], ['email' => 'bob@example.com'], ['email' => 'charlie@example.com']],
        'type' => 'event',
    ],
    [
        'id' => '2342353458808',
        'title' => 'Weekly Standup Part 2',
        'start' => '2024-05-23T10:00:00',
        'end' => '2024-05-23T11:00:00',
        'description' => 'Test description for Weekly Standup part 2',
        'location' => 'Virtual Meeting',
        'timezone' => 'America/Los_Angeles',
        // 'meetLink' => 'https://googlemeet.com123',
        // 'attendees' => [
        //     ['email' => ''],
        //     ['email' => ''],
        //     ['email' => ''],
...
// dd($taskOnGoogleCalendar);
// $taskOnGoogleCalendar = CalendarTask::all();

// $taskData = $taskOnGoogleCalendar
//     ->map(function ($task) {
//         $start = Carbon::parse($task->due)->format('Y-m-d\TH:i:s');
//         $end = Carbon::parse($task->due)->format('Y-m-d\TH:i:s');
//         return [
//             'id' => $task->id,
//             'title' => $task->title,
//             'start' => $start,
...
// $mergedData = array_merge($calendarEvents, $taskData);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="selectionModalLabel">Select Type</h5>
            ...
            <div class="modal-body">
                ...
                <form id="createEventForm" action="" method="POST">
                    ...
                    <div class="form-group row" id="assigneesField" style="display: none;">
                        <label for="assignees" class="col-sm-3 col-form-label">Participants:</label>
                        <div class="col-sm-9">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="POST">
                    ...
                    <p><strong id="participants">Participants:</strong><span id="eventDetailsModalAttendees"></span>
                    </p>
                    {{-- <ul id="eventDetailsModalAttendees"></ul> --}}

                    <div class="modal-footer">
                        <button type="submit" class="btn btn-accent btn-sm" id="updateEventBtn"
                            style="display: none;">Update Event</button>
                        {{-- <a href="" class="btn btn-accent btn-sm" id="updateEventBtn" style="display: none;">Update Event</a> --}}
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventDidMount: function(info) {
                // Check the type of the event and set the background color
                if (info.event.extendedProps.type === 'event') {
                    info.el.style.backgroundColor = '#ADD8E6';
                }
            },
            eventClick: function(info) {
                ...
                if (type === 'task') {
                    ...
                    // $('#taskDetailsModalEnd').text(end ? end.toLocaleString() : '');
                    $('#taskDetailsModalEnd').text(end ? new Date(end).toLocaleString() : '');
                } else if (type === 'event') {
                    // console.log(info.event);
                    ...
                    var timezone = info.event.extendedProps.timezone;
                    var meetLink = info.event.extendedProps.meetLink;

                    $('#eventDetailsModalTitle').text(title);
                    $('#eventDetailsModalStart').text(start.toLocaleString());
                    $('#eventDetailsModalEnd').text(end.toLocaleString());
                    $('#eventDetailsModalDescription').text(description);
                    $('#eventDetailsModalLocation').text(location);
                    $('#eventDetailsModalTimezone').text(timezone);
                    $("#eventDetailsModalMeetLink").text(meetLink);

                    // Extract and display email addresses of attendees
                    var attendeesText = '';
                    var attendees = info.event.extendedProps.attendees;
                    if (attendees && attendees.length > 0) {
                        attendeesText = attendees.map(function(attendee) {
...
<script>
    $(document).ready(function() {
                ...
                .each(function() {
                    ...
                    if ($(this).attr('id') === 'eventDetailsModalDescription') {
                        ...
                        var timezoneOptions = `
                            ...
                            <option value="America/Toronto">(GMT-04:00) Canada</option>
                        `;
                        input = $('<select name="timezone" class="form-control">' +
                        ...
                        input = $('<textarea name="assignees" class="form-control"></textarea>');
                        input.val(text);
        ...
        $("#cancelEventUpdateBtn").click(function() {
            ...
            $("#eventDetailsModal .modal-body input, #eventDetailsModal .modal-body textarea, #eventDetailsModal .modal-body select")
                .each(
                    function() {
