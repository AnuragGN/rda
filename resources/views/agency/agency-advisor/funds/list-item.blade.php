        ...
        <div class="gn-card card-fund-item gn-shadow">
            ...
            @else
                <div class="actions agency">
                    ...
                    @if(\App\Models\ContactFund::isViewable($fund->fund_id))
                        <a href="{{ route('agency-fund', [$fund->fund_id]) }}" class="btn btn-sm btn-theme">{{ $custom->text->FUND_OVERVIEW }}</a>
                    @endif
                    ...
                    @else
                        <a href="{{ route('agency-grant-history', [$fund->fund_id]) }}" class="btn btn-sm btn-theme">Disbursement History</a>
                    @endif
                    ...
                    @else
                        <a href="{{ route('agency-gift-history', [$fund->fund_id]) }}" class="btn btn-sm btn-theme">Contribution History</a>
                    @endif
