                        ...
                        <div class="form-group row" style="margin-bottom: 0">
                           <div class="col-xl-12" style="max-height: 500px;overflow-y: auto;">
                                <table class="table-pending-grants">
                                    <thead>
                                        <tr>
                                            <th style="text-align: left !important;width:50%;">Notification</th>
                                            <th style="text-align: left !important;width:30%;">Sent On</th>
                                            <th style="text-align: left !important;width:2%;">Status</th>
                                        </tr>
                                    </thead>
