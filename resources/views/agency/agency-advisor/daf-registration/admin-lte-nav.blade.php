        ...
        <nav class="mt-4">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent2 nav-compact nav-legacy nav--flatv-flat" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @if($linkAuthorization != \App\Models\DAFAccount::LINK_SAVED)
                    ...
                    <li class="nav-item">
                        <a href="{{route('agency-daf-account-info', $id)}}" class="nav-link">
                        ...
                        <ul class="nav">
                            @if ($additionalDonors && $linkAdditionalDonor != \App\Models\DAFAccount::LINK_DISABLED)
                                ...
                                @foreach ($additionalDonors as $donor => $name)
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('agency-daf-additional-donor',['key' => $name['key'], 'id' => $id])}}" class="nav-link">
                    ...
                    @if(\App\Models\ClientConfig::feature('DAF_REG_DAF_TYPE'))
                        @if($linkDAFType == \App\Models\DAFAccount::LINK_DISABLED)
                            <li class="nav-item">
                                <a class="nav-link">
                                    <i class="far fa-edit"></i>
                                    <p>DAF Type</p>
                        ...
                        @else
                            <li class="nav-item">
                                <a href="{{route('daf-type', $id)}}" class="nav-link">
                                    <i class="far fa-edit"></i>
                                    <p>DAF Type</p>
                                    <p>
                                    @include("donor.registration.menu-item-status", ['status' => $linkDAFType])
                                    </p>
                                </a>
                            </li>
                        @endif
                    ...
                    <li class="nav-item">
                        ...
                        @else
                            <a href="{{route('agency-daf-successors', $id)}}"
                            ...
                            @if( !$endowmentSelected && $endowmentInfo )
                                ...
                                <ul class="nav">
                                    <li class="nav-item">
                                        <a href="{{ route('agency-daf-successors-individuals', $id) }}"
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('agency-daf-successors-organizations', $id) }}"
                                           class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav">
                            ...
                            @else
                                <li class="nav-item">
                                    <a href="{{route('agency-daf-contributions-cash', $id)}}"
                                       class="nav-link ">
                                        <i class='fas fa-money-check-alt'></i>
                                        <p>Cash Equivalents</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{route('agency-daf-contributions-securities', $id)}}" class="nav-link">
                                        <i class='fas fa-money-check'></i>
                                        <p>Securities or Mutual Funds</p>
                                    </a>
                                </li>
                                ...
                                @if( in_array(App\Helpers\Data::DAFR_DONOR_CONTRIBUTIONS_STOCKS, $contributionTypes) )
                                    <li class="nav-item">
                                        <a href="{{route('agency-daf-contributions-stocks', $id)}}" class="nav-link">
                                            <i class='fas fa-money-check'></i>
                                            <p>Stock Certificates</p>
                                        </a>
                                    </li>
                                ...
                                @if( in_array(App\Helpers\Data::DAFR_DONOR_CONTRIBUTIONS_OTHERS, $contributionTypes) )
                                    <li class="nav-item">
                                        <a href="{{route('agency-daf-contributions-others', $id)}}" class="nav-link">
                                            <i class='fas fa-money-check'></i>
                                            <p>Others</p>
                                        </a>
                                    </li>
                    ...
                    @else
                        <li class="nav-item">
                            <a href="{{route('agency-daf-investments', $id)}}"
                               class="nav-link">
                                <i class="far fa-edit"></i>
                                <p>{{\App\Models\DAF\DAFInvestment::title()}}</p>
                                @include("donor.registration.menu-item-status", ['status' => $linkInvestments])
                    ...
                    @else
                        <li class="nav-item">
                            <a href="{{route('agency-daf-authorization', $id)}}"
                               class="nav-link">
                                <i class="far fa-edit"></i>
                                <p>{{ \App\Models\DAFAccount::reviewTitle() }}</p>
                                @include("donor.registration.menu-item-status", ['status' => $linkAuthorization])
                ...
                @else
                    ...
                    <hr class="hr-divider">
                    <li class="nav-item">
                        <a href="{{route('agency-daf-application-status', $id)}}" class="nav-link">
                            <i class="far fa-edit"></i>
