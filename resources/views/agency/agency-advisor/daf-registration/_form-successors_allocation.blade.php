...
<div class="form-group" id="id_allocation" >
    ...
    @elseif(\App\Models\ClientInfo::isPFR())
        <p>
            You need to develop a succession plan to succeed you and assume privileges on the Donor-Advised Fund.
            You can add up to {{$maxIndividuals}} Individuals and up to {{$maxOrgs}} Charitable Organizations.
        </p>
    @else
        <p>
