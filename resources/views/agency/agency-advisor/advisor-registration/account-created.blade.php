                ...
                <div class="row">
                    <div class="col-lg-10">
                        ...
                        <h3 class="advisor-title mb-3">
                            Thank you — your advisor account request has been received
                        </h3>

                        <p class="advisor-text">
                            We’ve sent a confirmation email to the email address you provided. Your request is now under
                            administrative review and your account will be activated once approved.
                        </p>

                        <div class="advisor-help-box">
                            <p class="advisor-section-title">What happens next</p>
                            <ul class="advisor-text">
                                <li>Our team will review your submission and activate your account once approved.</li>
                                <li>You will receive an email notification as soon as your account is ready to use.</li>
