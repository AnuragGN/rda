...
<head>
	...
	<link href="/ma/agency/css/brand.css" rel="stylesheet">  <!-- brand.css for Advisor firm branding  -->
    <link href="/ma/agency/css/media.css" rel="stylesheet">
    <link href="/ma/agency/css/colors.css" rel="stylesheet">
	<link rel="stylesheet" href="{{ asset('css/ai-helper.css') }}?v={{ time() }}">
    ...
    <script src="{{ asset('js/ai-helper.js') }}?v={{ time() }}"></script>
    {{--@include('utils.google-analytics')--}}
	
	<style>
		@if(\App\Models\FaPartner::getClientPrimaryColor())
		:root { --brand-accent: {{ \App\Models\FaPartner::getClientPrimaryColor() }}; }
		@endif
	</style>
...
<div class="wrapper">
    ...
    @include('agency.layouts.admin-lte-nav')
