        ...
        <div class="form-wrapper form-last">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    @include('donor.common.history-filter-cct', ['orgCls' => true])
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="gg-total">
                                Total {{\App\Helpers\GnUtils::money($grantTotal)}}
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-8 col-sm-10 col-12">
                    ...
                    <div class="chart-box">
                        ...
                        <div class="title">
                            Grant Distribution <span class="amount">{{\App\Helpers\GnUtils::money($grantTotal)}}</span>
                        </div>
