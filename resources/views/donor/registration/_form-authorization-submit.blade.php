...
@include('common.page-header', ['pageTitle' => 'Authorise & Submit'])
    ...
    <div class="form-body form-wrapper form-last custom-form">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('post-daf-authorization', $id) }}">
                    @csrf
            ...
            <div class="col-md-4">
                @include(\App\Models\ClientInfo::clientViewFor("registration.side-pane-authorization", "donor."))
            </div>
