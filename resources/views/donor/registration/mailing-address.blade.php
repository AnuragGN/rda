...
<div class="form-group row">
    ...
    <div class="col-md-1">
        <input type="checkbox" name="same_address" id="same-address"
               class="form-control2 checkbox-1x ml-1" value="1"
               {{ (old('same_address', $model->same_address ?? null) == '1' || old('same_address', $model->same_address ?? null) === true) ? 'checked' : '' }}>
    </div>
</div>
    </div>
</div>
...
<div class="mailing-address">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
            <input type="text" name="mailing_address_1" id="id_mailing_address_1" class="form-control"
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
            <input type="text" name="mailing_address_2" id="id_mailing_address_2" class="form-control"
                   maxlength="32"
    ...
    <div class="form-group row">
        ...
        <div class="col-md-3">
            <input type="text" name="mailing_city" id="id_mailing_city" class="form-control"
        ...
        <div class="col-md-3">
            <input type="text" name="mailing_zip" id="id_mailing_zip" class="form-control"
