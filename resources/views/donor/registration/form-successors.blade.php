    ...
    <div class="container pageTop">
        <div class="form-body form-wrapper form-last custom-form">
            <div class="row">
                ...
                <div class="col-md-8">
                    @include('donor.registration._form-successors_allocation', compact($successorDesignation = true))

                    <div class="form-group row pt-1">
                        <form method="POST" action="{{ route('post-daf-successors', $id) }}" id="id_form_endowment" class="form-horizontal offset-md-1">
                        @csrf
                        ...
                        <div class="form-check form-check-inline ml-1">
                            <input type="radio" name="isSelected" id="id_endowment"
                                   ...
                                   {{ old('isSelected', optional($successor)->isSelected) == '1' ? 'checked' : '' }}>
                            <label class="form-check-label" for="id_endowment">Establish a Permanent Endowment</label>
