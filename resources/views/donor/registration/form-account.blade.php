                ...
                <div class="col-md-8">
                    ...
                    <form method="POST"
                        ...
                        <div class="form-group">
                            ...
                            @else
                                <p>Please fill in the form below to create you DAF account.
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label text-right pr-0">Password</label>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label text-right pr-0">Confirm Password</label>
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <div class="input-group-text" style="cursor: pointer;">
                                            <i class="fas fa-eye-slash"
                                               data-target-id="password_confirmation"
                                               style="width: 20px;"
                                               onclick="showPassword(this)"></i>
