...
<div class="form-group row">
    ...
    <div class="col-md-6 pl-0">
        <input type="text" name="securities[{{ $i }}][fund_name]" id="securities_{{ $i }}_fund_name" class="form-control" value="{{ old('securities.'.$i.'.fund_name', $security->fund_name ?? '') }}" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-6 pl-0">
        <input type="text" name="securities[{{ $i }}][name]" id="securities_{{ $i }}_name" class="form-control" value="{{ old('securities.'.$i.'.name', $security->name ?? '') }}" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-6 pl-0">
        <input type="text" name="securities[{{ $i }}][account_number]" id="securities_{{ $i }}_account_number" class="form-control" value="{{ old('securities.'.$i.'.account_number', $security->account_number ?? '') }}" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-6 pl-0">
        <input type="text" name="securities[{{ $i }}][shares]" id="securities_{{ $i }}_shares" class="form-control" value="{{ old('securities.'.$i.'.shares', $security->shares ?? '') }}" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-6 pl-0">
        <input type="text" name="securities[{{ $i }}][amount]" id="securities_{{ $i }}_amount" class="form-control" value="{{ old('securities.'.$i.'.amount', $security->amount ?? '') }}" required>
    </div>
</div>
