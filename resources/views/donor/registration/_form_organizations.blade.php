...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input type="text" name="org_name" id="id_org_name" class="form-control" value="{{ old('org_name', $organization->org_name ?? '') }}" onkeypress="return /^[A-Za-z\s]*$/i.test(event.key)" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input type="text" name="contact_name" id="id_contact_name" class="form-control" value="{{ old('contact_name', $organization->contact_name ?? '') }}" onkeypress="return /^[A-Za-z\s]*$/i.test(event.key)" maxlength="32" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-3">
        <input type="number" name="giving" id="id_giving" class="form-control" value="{{ old('giving', $organization->giving ?? '') }}" onchange="handleGivingChange(this);" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-3">
        <input type="text" name="ein" id="id_ein" class="form-control org_ein" value="{{ old('ein', $organization->ein ?? '') }}" maxlength="10" placeholder="22-7777777">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-3">
        <input type="text" name="phone_number" id="id_phone" class="form-control phone_number" value="{{ old('phone_number', $organization->phone_number ?? '') }}" onkeypress="return /[0-9]/i.test(event.key)">
    </div>
</div>

@include('donor.registration.address', ['model' => $organization])
