...
<form method="POST" action="{{ route('post-daf-contributions-cash', $id) }}" id="daf-account-info-form">
    @csrf
    ...
    <div class="form-group row">
        ...
        <div class="col-md-2 pl-0 pr-0">
            <input type="number" name="ach_amount" id="id_ach_amount" class="form-control" value="{{ old('ach_amount', $contributions->ach_amount ?? '') }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-5 pl-0 pr-0">
            <input type="text" name="ach_bank" id="id_ach_bank" class="form-control" value="{{ old('ach_bank', $contributions->ach_bank ?? '') }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-2 pl-0 pr-0">
            <input type="number" name="wire_amount" id="id_wire_amount" class="form-control" value="{{ old('wire_amount', $contributions->wire_amount ?? '') }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-5 pl-0 pr-0">
            <input type="text" name="wire_bank" id="id_wire_bank" class="form-control" value="{{ old('wire_bank', $contributions->wire_bank ?? '') }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-2 pl-0 pr-0">
            <input type="number" name="check_amount" id="id_check_amount" class="form-control" value="{{ old('check_amount', $contributions->check_amount ?? '') }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-5 pl-0 pr-0">
            <input type="text" name="check_bank" id="id_check_bank" class="form-control" value="{{ old('check_bank', $contributions->check_bank ?? '') }}">
        </div>
    </div>
