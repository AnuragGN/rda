            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-make-grant gn-form">
                        ...
                        <form method="POST" action="{{ route('post-daf-investments', $id) }}" id="id_investments_form" class="pl-2 pr-2">
                        @csrf
                        ...
                        @include(\App\Models\ClientInfo::clientViewFor("registration.help-footer-investments", "donor."))

                    </div>
                </div>

                <div class="col-md-4">
                    @include(\App\Models\ClientInfo::clientViewFor("registration.side-pane-investments", "donor."))
                </div>
