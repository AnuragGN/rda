    ...
    <div class="form-wrapper form-last">
        <div class="row">
            <div class="col-xl-7 col-r-15">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-sm-12 text-right">
                                ...
                                <a href="{{route('donor-service-ticket-create')}}" 
                                   class="btn btn-accent btn-sm mr-2 ml-2">
                                    Create Ticket <i class="nav-icon fas fa-wrench"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @include('donor.ticket.list-loader')
                <br>
            </div> 
...
function getTicketList() {
    ...
    jsTicketLoader.init('/m/ticket-ajax');
