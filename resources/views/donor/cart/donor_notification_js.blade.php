...
function get_donor_notification_popup(cart_id){
...
function send_notification(){
    ...
    if(notification == '')
    {
        $("#notification").css('border-color', 'red'); return false;
    }
    $("#notification-form").submit();
}

function donor_notification_logs(cart_id){

    var html = '';
    html += `<tr>
        <td style="text-align: left !important;">New Notification</td>
        <td style="text-align: left !important;">Cliff Stevenson</td>
        <td style="text-align: left !important;">John Paul</td>
        <td style="text-align: left !important;">06-11-2023</td>
        <td style="text-align: left !important;">Read</td>
    </tr>`;
    // html += `<tr>
    //     <td colspan="5" style="text-align: center !important;"><i class="fas fa-exclamation-triangle"></i> No data available!</td>
    // </tr>`;
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('agency-sent-notification') }}" name="notification-form" id="notification-form">
                 @csrf
                        ...
                        <div class="body">
                            <div class="form-group row" style="margin-bottom: 0">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="hidden" id="hyd_cart_id" name="cart_id" value="0">
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="exampleModalNotificationLogs" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content" style="width: 641px;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Notification Logs</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="col-xl-12">
                        ...
                        <div class="form-group row" style="margin-bottom: 0">
                           <div class="col-xl-12" style="max-height: 500px;overflow-y: auto;">
                                <table class="table-pending-grants">
                                    <thead>
                                        <tr>
                                            <th style="text-align: left !important;width:40%;">Notification</th>
                                            <th style="text-align: left !important;width:20%;">Sent By</th>
                                            <th style="text-align: left !important;width:15%;">Sent To</th>
                                            <th style="text-align: left !important;width:15%;">Sent On</th>
                                            <th style="text-align: left !important;width:10%;">Status</th>
                                        </tr>
                                    </thead>
