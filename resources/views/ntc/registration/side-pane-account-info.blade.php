<div class="info-card mb-3">
  Any grants made to approved charities will be accompanied by a letter that includes the Donor-Advised fund name, unless a specific request is made for the grant to remain anonymous.
</div>
<div class="info-card">
    ...
    @include('cct.registration.daf-program-guide-link')
