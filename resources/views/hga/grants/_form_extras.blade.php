...
$dedicationTypes = [
        ...
        'Include Name/Address' => 'Please include my name and address.',
];
?>

<div class="form-group row">
    {!! Form::label('purpose_type', 'Designation/Purpose', ['class' => 'col-sm-3 col-form-label text-right pr-0']) !!}
    <div class="col-md-9 form-control" style="border: none; background: none;">
        <div class="form-check form-check-inline">
            ...
            <label class="form-check-label font-small" for="id_purpose_general">Undesignated</label>
        </div>
        <div class="form-check form-check-inline">
            {!! Form::radio('purpose_type', 'special', null, ['class' => 'form-check-input', 'id' => "id_purpose_special", "onclick" => "onSpecialPurpose(this);"]) !!}
            <label class="form-check-label font-small" for="id_purpose_special">Designated</label>
        </div>
    </div>
</div>
...
<div class="form-group row" id="id_grant_purpose_container" style="display: none;">
    <div class="offset-md-3  col-sm-9">
        {!! Form::textarea('grant_purpose', null, ['class' => 'form-control', 'rows' => 2, 'id' => 'id_grant_purpose', 'placeholder' => 'Purpose (included on grant check)']) !!}
    </div>
</div>

<div class="form-group row">
    {!! Form::label('dedication_type', 'Recognition', ['class' => 'col-sm-3 col-form-label text-right pr-0']) !!}
    <div class="col-sm-9">
...
<div class="form-group row" id="id_grant_dedication_container" style="display: none;">
    <div class="offset-md-3  col-sm-9">
        {!! Form::textarea('grant_dedication', null, ['class' => 'form-control', 'rows' => 2, 'id' => 'id_grant_dedication', 'placeholder' => 'How would you like your name to appear?']) !!}
    </div>
</div>
