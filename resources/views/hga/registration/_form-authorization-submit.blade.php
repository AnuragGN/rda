...
@include('common.page-header', ['pageTitle' => 'ACKNOWLEDGMENT & SUBMISSION'])
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <p class="form-title">ACKNOWLEDGMENT</p>
                </div>
                ...
                <form method="post" action="{{route('post-daf-authorization')}}">
                    ...
                    <div class="form-group">
                        <div class="form-check form-check-inline form-check-authorize">
                            ...
                            <label class="form-check-label text-bold" for="id_authorization">I acknowledge and agree.</label>
                        </div>
                    ...
                    <div style="text-align: center;">
                        <div class="font-small">Once your application is submitted, you will receive an email confirmation.<br>Upon approval of your application, HighGround will send final documentation for electronic
                            signature via email.</div>
                    </div>
                </form>
